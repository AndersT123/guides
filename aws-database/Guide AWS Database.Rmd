...
EC-2 Instance (Ubuntu 18.04) with RStudio Server and Shiny Server installed.
...
Want to have a flow like: local app --> GitHub --> Travis CI --> EC-2 (Shiny Server)
Current flow: local app --> GitHub --> Travis CI --> Login to EC-2 (RStudio Server) pull from GitHub, test --> cp to srv/shiny-server
